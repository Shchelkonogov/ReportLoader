...
public class Type6 {
	...
	private static List<String> dbParamNameIntegr = Arrays.asList("Дата", "Qi", "T1", "T2", "T3", "V1i", "V2i", "p1", "p2",
			"Timei", "Timei", "p1", "p2", "нет", "V3i", "Дата", "G1i", "G2i", "T3",
			"нет", "нет", "нет", "нет",
			"Дата", "Qi", "T1", "T2", "G1i", "G2i", "p1", "p2", "Timei",
			"Timei", "Дата", "T3", "V3i", "V1i", "V2i", "T3", "нет", "нет", "p1",
			"p2", "нет", "нет", "нет",
			"Дата", "T3", "V3i", "нет", "нет", "Дата", "нет",
			"Дата", "Qi", "T1", "T2", "G1i", "G2i", "Timei", "нет", "нет",
			"Дата", "Timei", "p1", "p2");
